          ...
          <ul class="md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            <router-link to="/groups">
              <li>
                <div class="navButton">
                  ...
                  <a href="#"
                     class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Groupes</a>
                </div>
              </li>
            </router-link>
            ...
            <li>
              <div class="navButton">
                ...
                <Dialog header="Livecoding" v-model:visible="displayBasic" :breakpoints="{'960px': '75vw', '640px': '90vw'}"
                        :style="{width: '50vw'}">
                  ...
                  <template #footer>
                    <Button label="Créer une session" icon="pi pi-times" @click="createSession" class="p-button-text"/>
                    <Button label="Rejoindre une session" icon="pi pi-check" @click="joinSession(livecodingId)" autofocus/>
                  </template>
                </Dialog>
              </div>
            </li>
